...
public class ElasticsearchTests {
    ...
    public void testSearchByRepository() {
        ...
        Page<DiscussPost> page = (Page<DiscussPost>) SearchHitSupport.unwrapSearchHits(searchPage);
        ...
        for (SearchHit hit : searchHits) {
            ...
            // 处理高亮显示的结果
            List titleField = (List) hit.getHighlightFields().get("title");
            if (titleField != null) {
                post.setTitle(titleField.get(0).toString());
            }

            List contentField = (List) hit.getHighlightFields().get("content");
